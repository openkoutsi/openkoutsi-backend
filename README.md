...
Mounting the endpoint is not the same as publishing it: it answers only to a
credential this instance issued, and a self-hoster who doesn't want it reachable
from outside simply doesn't route `/mcp` through their reverse proxy — see
[DEPLOY.md](DEPLOY.md).

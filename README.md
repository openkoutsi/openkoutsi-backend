...
- **Privacy-first** — explicit GDPR consent for health-data processing, a configurable per-instance privacy policy served at `GET /api/legal/privacy-policy`, and export/delete your data at any time

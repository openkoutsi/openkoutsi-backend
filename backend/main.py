...
async def lifespan(app: FastAPI):
    ...
    # whatever was in flight. Settling that before the first request is served is
    # what stops a redeploy costing an athlete an analysis they cannot re-request.
    #
    ...
    # about the deployment rather than this process, and a rolling redeploy

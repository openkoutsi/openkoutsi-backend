...
class TrainingStatusResponse(BaseModel):
    ...
    # JSON. Derived from the prose rather than stored so the two cannot drift:
    # whenever there is feedback, a model wrote it.
    @computed_field  # type: ignore[prop-decorator]
    @property
    def feedback_ai_generated(self) -> bool:
        """True when `feedback` holds text generated by a language model."""
